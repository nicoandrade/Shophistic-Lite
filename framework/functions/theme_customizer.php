...
function shophistic_lite_quemalabs_options_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        new Button( $wp_customize, 'shophistic', [
            'title'       => __( 'Shophistic', 'shophistic-lite' ),
            'button_text' => __( 'Go Pro', 'shophistic-lite' ),
            'button_url'  => 'https://www.quemalabs.com/theme/shophistic/?utm_source=Shophistic%20Lite%20Theme&utm_medium=Pro%20Button&utm_campaign=Shophistic',
            'priority'    => 10,
        ] )
    );
...
if ( ! function_exists( 'shophistic_lite_customizer_controls' ) ) {
    function shophistic_lite_customizer_controls() {
        ...
        wp_enqueue_script(
            ...
            get_template_directory_uri() . '/vendor/wptrt/customize-section-button/public/js/customize-controls.js',
            ['customize-controls'],
            $version,
            true
        );
        ...
        wp_enqueue_style(
            'wptrt-customize-section-button',
            get_template_directory_uri() . '/vendor/wptrt/scustomize-section-button/public/css/customize-controls.css',
            ['customize-controls'],
            $version
        );

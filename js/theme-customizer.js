...
(function($) {
  ...
  */
    ...
    wp.customize("quemalabs_options[header_color_text]", function(value) {
        value.bind(function(newval) {
            $(
                "#header, #header a, .logo_container .ql_logo, #jqueryslidemenu ul.nav > li a"
            ).each(function(index, el) {
                $(el).style("color", newval, "important");
            });
        });
  ...
  */
    ...
    wp.customize("quemalabs_options[footer_color_text]", function(value) {
        value.bind(function(newval) {
            $(
                ".footer_wrap, #footer, #footer ul li > a, footer ol li > a, #footer h4, #footer ul li, #footer ol li, .sub_footer, .sub_footer a"
            ).each(function(index, el) {
                $(el).style("color", newval, "important");
            });
  ...
  */
    ...
    wp.customize("quemalabs_options[content_typography_color]", function(
        value
    ) {
        value.bind(function(newval) {
